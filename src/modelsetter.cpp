    ...
    QWidget(parent), _object(object)
{
    ...
    // Create Object Settings Panel
    {
        ...
        _scale = new ModelAttributeSlide("Scale", 0.01, 1, 20, _objectSettingPanel);
        _rotateX = new ModelAttributeSlide("RotateX", 0, 360, 16, _objectSettingPanel);
        _rotateY = new ModelAttributeSlide("RotateY", 0, 360, 16, _objectSettingPanel);
        _rotateZ = new ModelAttributeSlide("RotateZ", 0, 360, 16, _objectSettingPanel);
